# Instagram DM Bot — Gemini AI Auto-Reply (n8n)

Bot de resposta automática para DMs do Instagram construído no [n8n](https://n8n.io), usando a **API do Google Gemini** para gerar respostas naturais e o webhook da **Meta for Developers** para receber os eventos de mensagem em tempo real.
